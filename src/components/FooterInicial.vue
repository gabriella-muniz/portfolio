  ...
  <footer id="contact" class="bg-[#3A3A3D] text-white px-[8%] py-0 max-w-[100rem] mx-auto w-[100%]">
    <div class="flex flex-col sm:flex-row justify-between py-[7%]">
      <div class="mb-[3rem] sm:mb-0">
        ...
        <p class="text-[#F4F6F9] text-[0.9rem] leading-[1.7] font-font2">
          Espero que tenha apreciado meu portfólio. Para obter mais informações, você pode encontrá-las nas minhas redes sociais.
        </p>
      </div>

      <div>
        <h4 class="mb-[1.6rem] font-font text-[1.5rem]">SOCIAL</h4>
